...
Route::get('/portofolio/{slug}', [\App\Http\Controllers\Api\PortfolioController::class, 'show']);

Route::get('/archivement', [\App\Http\Controllers\Api\ArchivementController::class, 'index']);
Route::get('/archivement/{id}', [\App\Http\Controllers\Api\ArchivementController::class, 'show']);
